          ...
          <div className="pt-6">
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <Button variant="ghost" className="w-full text-destructive/40 hover:text-destructive hover:bg-destructive/10 h-11 text-[10px] font-black uppercase tracking-[0.2em] rounded-xl">
